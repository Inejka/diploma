...
// document.sent_images = "AJAJAJ"
// chrome.storage.sync.get(['latest_url'], function (result) {
//     const url_with_model = result.latest_url;
//
//     // Define a function to add a random number to an image
//     function addRandomNumberToImage(image) {
//         console.log(document.sent_images)
...
//         const numberSize = imageSize / 10;
//
//         // Generate a random number between 1 and 100
//
//         fetch(url_with_model, {
//             method: 'POST',
//             headers: {
...
//                 const randomNumber = data["data"][0];
//                 // Set the position and size of the number square
//                 number.style.position = "absolute";
//                 number.style.top = `${image.offsetTop + 15}px`;
//                 number.style.left = `${image.offsetLeft + (image.width - numberSize) - 15}px`;
...
//     }
//
// // Define a function to observe changes to the DOM and add random numbers to new images
...
//             // Check if the image already has a random number
//             if (image.parentNode.querySelector("div")) {
//                 return;
//             }
//
//             // Add a random number to the image
//             addRandomNumberToImage(image);
//         });
//         // Observe changes to the DOM and add random numbers to new images
//     }
//
// // Start observing changes to the DOM and adding random numbers to images
...
//
//     const images = document.querySelectorAll('img');
//     images.forEach(addRandomNumberToImage);
//
//
// });
